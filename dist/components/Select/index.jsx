...
var Select = function (_a) {
    var label = _a.label, options = _a.options, value = _a.value, isSearched = _a.isSearched, helperText = _a.helperText, _b = _a.maxVisibleOptions, maxVisibleOptions = _b === void 0 ? 3 : _b, rest = __rest(_a, ["label", "options", "value", "isSearched", "helperText", "maxVisibleOptions"]);
    ...
    return (<fieldset className="relative">
      <Label htmlFor={(rest === null || rest === void 0 ? void 0 : rest.id) || "select-input"} label={label || ""} isActive={!!(selectedOption === null || selectedOption === void 0 ? void 0 : selectedOption.value) || isDropdownOpen} required={rest === null || rest === void 0 ? void 0 : rest.required}/>

      <Input {...rest} id={(rest === null || rest === void 0 ? void 0 : rest.id) || "select-input"} value={(selectedOption === null || selectedOption === void 0 ? void 0 : selectedOption.label) || ""} onClick={function () { return setIsDropdownOpen(function (prev) { return !prev; }); }} isFocus={isDropdownOpen} isSearched={isSearched} onChange={handleSearchChange}/>
      
      

      {isDropdownOpen && (<Dropdown options={optionsList} onOptionSelect={handleOptionSelect} maxVisibleOptions={maxVisibleOptions} selectedOption={selectedOption}/>)}
